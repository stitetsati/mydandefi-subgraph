...
import { AdminChanged, BeaconUpgraded, Upgraded } from "../generated/MyDanDefiProxy/MyDanDefiProxy";
...
export function createAdminChangedEvent(previousAdmin: Address, newAdmin: Address): AdminChanged {
  ...
  adminChangedEvent.parameters.push(new ethereum.EventParam("previousAdmin", ethereum.Value.fromAddress(previousAdmin)));
