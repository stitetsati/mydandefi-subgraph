...
export class MembershipInserted__Params {
  ...
  get insertedMembershipTier(): MembershipInsertedInsertedMembershipTierStruct {
    return changetype<MembershipInsertedInsertedMembershipTierStruct>(
...
export class MembershipUpdated__Params {
  ...
  get updatedMembershipTier(): MembershipUpdatedUpdatedMembershipTierStruct {
    return changetype<MembershipUpdatedUpdatedMembershipTierStruct>(
      this._event.parameters[1].value.toTuple()
    );
  }
}
...
export class MyDanDefi extends ethereum.SmartContract {
  ...
  assetsUnderManagementCap(): BigInt {
    let result = super.call(
      "assetsUnderManagementCap",
      "assetsUnderManagementCap():(uint256)",
      []
    );
  ...
  claimPass(referralCode: string): BigInt {
    let result = super.call("claimPass", "claimPass(string):(uint256)", [
  ...
  try_claimPass(referralCode: string): ethereum.CallResult<BigInt> {
    let result = super.tryCall("claimPass", "claimPass(string):(uint256)", [
      ethereum.Value.fromString(referralCode)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  claimReferralBonus(tokenId: BigInt, referralBonusIds: Array<BigInt>): BigInt {
    let result = super.call(
      "claimReferralBonus",
      "claimReferralBonus(uint256,uint256[]):(uint256)",
      [
  ...
  try_claimReferralBonus(
    tokenId: BigInt,
    referralBonusIds: Array<BigInt>
  ...
  collectInterests(tokenId: BigInt, depositIds: Array<BigInt>): BigInt {
    let result = super.call(
      "collectInterests",
      "collectInterests(uint256,uint256[]):(uint256)",
      [
        ethereum.Value.fromUnsignedBigInt(tokenId),
  ...
  try_collectInterests(
    tokenId: BigInt,
    depositIds: Array<BigInt>
  ): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "collectInterests",
      "collectInterests(uint256,uint256[]):(uint256)",
  ...
  depositDurations(param0: BigInt): BigInt {
    let result = super.call(
      "depositDurations",
      "depositDurations(uint256):(uint256)",
  ...
  deposits(param0: BigInt, param1: BigInt): MyDanDefi__depositsResult {
    let result = super.call(
      "deposits",
      "deposits(uint256,uint256):(uint256,uint256,uint256,uint256,uint256,uint256,uint256)",
      [
        ethereum.Value.fromUnsignedBigInt(param0),
    ...
    return new MyDanDefi__depositsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_deposits(
    param0: BigInt,
    param1: BigInt
  ): ethereum.CallResult<MyDanDefi__depositsResult> {
    let result = super.tryCall(
      "deposits",
      "deposits(uint256,uint256):(uint256,uint256,uint256,uint256,uint256,uint256,uint256)",
      [
  ...
  durationBonusRates(param0: BigInt): BigInt {
    let result = super.call(
      "durationBonusRates",
      "durationBonusRates(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );
  ...
  getAllReferrers(tokenId: BigInt): Array<BigInt> {
    let result = super.call(
      "getAllReferrers",
      "getAllReferrers(uint256):(uint256[])",
      [ethereum.Value.fromUnsignedBigInt(tokenId)]
    );
  ...
  getClaimableReferralBonus(
    tokenId: BigInt,
    referralBonusIds: Array<BigInt>
  ): BigInt {
    let result = super.call(
      "getClaimableReferralBonus",
      "getClaimableReferralBonus(uint256,uint256[]):(uint256)",
      [
        ethereum.Value.fromUnsignedBigInt(tokenId),
        ethereum.Value.fromUnsignedBigIntArray(referralBonusIds)
      ]
  ...
  getCollectableInterests(tokenId: BigInt, depositIds: Array<BigInt>): BigInt {
    let result = super.call(
      "getCollectableInterests",
      "getCollectableInterests(uint256,uint256[]):(uint256)",
      [
        ethereum.Value.fromUnsignedBigInt(tokenId),
        ethereum.Value.fromUnsignedBigIntArray(depositIds)
      ]
  ...
  isValidDepositDuration(duration: BigInt): boolean {
    let result = super.call(
      "isValidDepositDuration",
      "isValidDepositDuration(uint256):(bool)",
      [ethereum.Value.fromUnsignedBigInt(duration)]
    );
  ...
  membershipTiers(param0: BigInt): MyDanDefi__membershipTiersResult {
    let result = super.call(
      "membershipTiers",
      "membershipTiers(uint256):(string,uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );

    return new MyDanDefi__membershipTiersResult(
      result[0].toString(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_membershipTiers(
    param0: BigInt
  ): ethereum.CallResult<MyDanDefi__membershipTiersResult> {
    let result = super.tryCall(
      "membershipTiers",
      "membershipTiers(uint256):(string,uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new MyDanDefi__membershipTiersResult(
        value[0].toString(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  profiles(param0: BigInt): MyDanDefi__profilesResult {
    let result = super.call(
      "profiles",
      "profiles(uint256):(uint256,string,uint256,uint256,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );

    return new MyDanDefi__profilesResult(
      result[0].toBigInt(),
      result[1].toString(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  referralBonusRates(param0: BigInt): BigInt {
    let result = super.call(
      "referralBonusRates",
      "referralBonusRates(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );
  ...
  referralBonuses(
    param0: BigInt,
    param1: BigInt
  ): MyDanDefi__referralBonusesResult {
    let result = super.call(
      "referralBonuses",
      "referralBonuses(uint256,uint256):(uint256,uint256,uint256,uint256,uint256,uint256,uint256)",
      [
        ethereum.Value.fromUnsignedBigInt(param0),
        ethereum.Value.fromUnsignedBigInt(param1)
      ]
  ...
  try_referralBonuses(
    param0: BigInt,
    param1: BigInt
  ): ethereum.CallResult<MyDanDefi__referralBonusesResult> {
    let result = super.tryCall(
      "referralBonuses",
      "referralBonuses(uint256,uint256):(uint256,uint256,uint256,uint256,uint256,uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new MyDanDefi__referralBonusesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  tierActivationLogs(
    ...
    param1: BigInt,
    param2: BigInt
  ): MyDanDefi__tierActivationLogsResult {
    let result = super.call(
      "tierActivationLogs",
      "tierActivationLogs(uint256,uint256,uint256):(uint256,uint256)",
      [
        ethereum.Value.fromUnsignedBigInt(param0),
        ethereum.Value.fromUnsignedBigInt(param1),
    ...
    return new MyDanDefi__tierActivationLogsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_tierActivationLogs(
    param0: BigInt,
    param1: BigInt,
    param2: BigInt
  ): ethereum.CallResult<MyDanDefi__tierActivationLogsResult> {
    let result = super.tryCall(
      "tierActivationLogs",
      "tierActivationLogs(uint256,uint256,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new MyDanDefi__tierActivationLogsResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  toLowerCase(str: string): string {
    let result = super.call("toLowerCase", "toLowerCase(string):(string)", [
  ...
  try_toLowerCase(str: string): ethereum.CallResult<string> {
    let result = super.tryCall("toLowerCase", "toLowerCase(string):(string)", [
      ethereum.Value.fromString(str)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
...
export class EditMembershipTierCall__Inputs {
  ...
  get updatedMembershipTier(): EditMembershipTierCallUpdatedMembershipTierStruct {
    return changetype<EditMembershipTierCallUpdatedMembershipTierStruct>(
...
export class InsertMembershipTiersCall__Inputs {
  ...
  get newMembershipTiers(): Array<
    InsertMembershipTiersCallNewMembershipTiersStruct
  > {
