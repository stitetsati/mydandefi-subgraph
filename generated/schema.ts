...
export class MembershipTier extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type MembershipTier must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
  ...
  static loadInBlock(id: string): MembershipTier | null {
    return changetype<MembershipTier | null>(
      store.get_in_block("MembershipTier", id)
    );
  }
...
export class Profile extends Entity {
  ...
  set totalAnnualizedRewardsPlusReferralBonuses(value: BigDecimal) {
    this.set(
      "totalAnnualizedRewardsPlusReferralBonuses",
  ...
  get referralBonuses(): ReferralBonusLoader {
    return new ReferralBonusLoader(
      "Profile",
      this.get("id")!.toString(),
      "referralBonuses"
    );
  ...
  get referralLevelData(): ProfileReferralLevelDataLoader {
    return new ProfileReferralLevelDataLoader(
      "Profile",
      this.get("id")!.toString(),
      "referralLevelData"
    );
...
export class ReferralBonus extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type ReferralBonus must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
  ...
  static loadInBlock(id: string): ReferralBonus | null {
    return changetype<ReferralBonus | null>(
      store.get_in_block("ReferralBonus", id)
    );
  }
...
export class ReferralLevel extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type ReferralLevel must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
  ...
  static loadInBlock(id: string): ReferralLevel | null {
    return changetype<ReferralLevel | null>(
      store.get_in_block("ReferralLevel", id)
    );
  }
...
export class ProfileReferralLevelData extends Entity {
  ...
  save(): void {
    ...
    assert(
      id != null,
      "Cannot save ProfileReferralLevelData entity without an ID"
    );
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type ProfileReferralLevelData must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
  ...
  static loadInBlock(id: string): ProfileReferralLevelData | null {
    return changetype<ProfileReferralLevelData | null>(
      store.get_in_block("ProfileReferralLevelData", id)
    );
  }

  static load(id: string): ProfileReferralLevelData | null {
    return changetype<ProfileReferralLevelData | null>(
      store.get("ProfileReferralLevelData", id)
    );
  }
